...
write.table(data.frame(),"meansP0_AncientDNA_normalized",row.names=F,quote=FALSE)
...
if (length(args)<1){
	...
	stop("No valid standardization method specified!")}

if (normalization_val==0){
	stop('!!! Normalization value is zero. Are all individuals identical? Terminating normalization, please fix and rerun READ !!!')
}
